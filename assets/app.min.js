...
"use strict";!function(o){o(".load-average").tooltip({placement:"top",trigger:"hover"}).tooltip("hide"),o(".popup-delete-user").click(function(){var t=o(this).data("user");o("#deleteUserName").val(t),o("#target-delete-user").html(t)}),o("#logout").click(function(){var t=o(this).data("logouturl"),e=o(this).data("logoutmessage"),a=window.location.protocol,i=window.location.host,l=window.location.pathname;o.ajax({xhrFields:{withCredentials:!0},headers:{Authorization:"Basic "+btoa("logout:logout")},url:a+"//"+i+l}),o.loader({id:"jquery-loader",className:"",content:'<p><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i></p><p>'+e+"</p>",height:60,width:200,background:{id:"jquery-loader-background"}}),setTimeout(function(){window.location.href=t},2e3)})}(jQuery);