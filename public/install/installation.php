            ...
            <section class="row">
                <article class="col-md-12">
                    <div class="well well-sm">
                        ...
                        <code>chown -R <?= $user_name_php['name'].':'.$user_name_php['name'].' '.$root_path; ?>/</code>
                        <p>Exécutez le script install.sh pour compiler le programme de reboot en ROOT.</p>
                        <code>cd <?= $root_path; ?>/source-reboot-rtorrent/ </code>
                ...
                <article class="col-md-12">
                    <div class="well well-sm">
                        ...
                        <code>nano <?= $root_path; ?>/conf/users/<?= $userName; ?>/config.ini</code>
