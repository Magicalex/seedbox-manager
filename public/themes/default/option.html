        ...
        <form method="post" action="?option" role="form">
            <div class="col-md-6">
                <fieldset>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="active_support" value="1" id="active_support" {% if user.blocSupport == true %}checked{% endif %} >
                            Activer le bloc support
                        </label>
                    </div>
                </fieldset>
            </div>
            ...
            <p class="text-right fix-marg-input">
                <input type="hidden" name="conf_user">
