...
!function(o){o(".load-average").tooltip({placement:"top",trigger:"hover"}).tooltip("hide"),o(".popup-delete-user").click(function(){var e=o(this).data("user");o("#deleteUserName").val(e),o("#target-delete-user").html(e)}),o("#logout").click(function(){var e=o(this).data("urlredirect"),t=window.location.protocol,a=window.location.host,i=window.location.pathname;o.get(t+"//logout@"+a+i),o.loader({id:"jquery-loader",className:"",content:"<span>Déconnexion...</span>",height:60,width:200,background:{id:"jquery-loader-background"}}),setTimeout(function(){window.location.href=e},1e3)})}(jQuery);