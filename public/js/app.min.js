...
"use strict";!function(o){o(".load-average").tooltip({placement:"top",trigger:"hover"}).tooltip("hide"),o(".popup-delete-user").click(function(){var t=o(this).data("user");o("#deleteUserName").val(t),o("#target-delete-user").html(t)}),o("#logout").click(function(){var t=o(this).data("logouturl"),e=o(this).data("logoutmessage"),a=window.location.protocol,i=window.location.host,l=window.location.pathname,r=a+"//"+i+l;console.log(r),o.ajax({xhrFields:{withCredentials:!0},headers:{Authorization:"Basic "+btoa("logout:logout")},url:r}),o.loader({id:"jquery-loader",className:"",content:"<span>"+e+"</span>",height:60,width:200,background:{id:"jquery-loader-background"}}),setTimeout(function(){window.location.href=t},2e3)})}(jQuery);