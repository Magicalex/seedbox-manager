...
var jQueryLoaderOptions=null;!function(e){e.loader=function(t){switch(t){case"close":return void(jQueryLoaderOptions&&e("#"+jQueryLoaderOptions.id)&&e("#"+jQueryLoaderOptions.id+", #"+jQueryLoaderOptions.background.id).remove());case"setContent":return void(jQueryLoaderOptions&&e("#"+jQueryLoaderOptions.id)&&(2==arguments.length?e("#"+jQueryLoaderOptions.id).html(arguments[1]):console?console.error("setContent method must have 2 arguments $.loader('setContent', 'new content');"):alert("setContent method must have 2 arguments $.loader('setContent', 'new content');")));default:var o=e.extend({content:"Loading ...",className:"loader",id:"jquery-loader",height:60,width:200,zIndex:3e4,background:{opacity:.4,id:"jquery-loader-background"}},t)}jQueryLoaderOptions=o;var n=e(document).height(),i=e(window).width(),d=e('<div id="'+o.background.id+'"/>');d.css({zIndex:o.zIndex,position:"absolute",top:"0px",left:"0px",width:i,height:n,opacity:o.background.opacity}),d.appendTo("body"),jQuery.bgiframe&&d.bgiframe();var r=e('<div id="'+o.id+'" class="'+o.className+'"></div>');r.css({zIndex:o.zIndex+1,width:o.width,height:o.height}),r.appendTo("body"),r.center(),r.html(o.content)},e.fn.center=function(){return this.css("position","absolute"),this.css("top",(e(window).height()-this.outerHeight())/2+e(window).scrollTop()+"px"),this.css("left",(e(window).width()-this.outerWidth())/2+e(window).scrollLeft()+"px"),this}}(jQuery);
!function(e){e(".load-average").tooltip({placement:"top",trigger:"hover"}).tooltip("hide"),e("#popupfilezilla").popover({html:!0,trigger:"hover",content:" &bull; Cliquer sur ce bouton.<br> &bull; Ouvrir filezilla.<br> &bull; Fichier -> Importer les paramètres.<br> &bull; Sélectionner le fichier filezilla.xml.<br> &bull; C'est terminé !",title:"Configurer filezilla rapidement !",placement:function(){return e(window).width()>=979?"right":"top"}}),e("#popuptransdroid").popover({html:!0,trigger:"hover",content:"Génère un fichier de configuration pour l'application transdroid.",title:"Configurer transdroid rapidement !",placement:function(){return e(window).width()>=979?"right":"top"}}),e(".popup-delete-user").click(function(){var t=e(this).data("user");e("#deleteUserName").val(t),e("#target-delete-user").html('<i class="glyphicon glyphicon-trash"></i> Suppression de l\'utilisateur : <strong>'+t+"</strong>")}),e("#logout").click(function(){var t=e(this).data("urlredirect"),i=window.location.protocol,o=window.location.host,r=window.location.pathname;e.get(i+"//logout@"+o+r),e.loader({id:"jquery-loader",className:"",content:"<span>Déconnexion...</span>",height:60,width:200,background:{id:"jquery-loader-background"}}),setTimeout(function(){window.location.href=t},1e3)})}(jQuery);